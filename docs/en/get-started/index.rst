...
.. note::
    ...
    ESP-ADF has support for specific IDF versions (v3.3.1, v4.0 and v4.1) <https://docs.espressif.com/projects/esp-idf/en/v3.3.1/versions.html>`_. If your have already set up another version, please switch to one of the supported ESP-IDF versions, or you may not be able to compile ESP-ADF applications.
